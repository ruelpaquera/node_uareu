...
Nan::NAN_METHOD_RETURN_TYPE Menu_Create(an::NAN_METHOD_ARGS_TYPE info);
Nan::NAN_METHOD_RETURN_TYPE Menu_Destroy(an::NAN_METHOD_ARGS_TYPE info);
Nan::NAN_METHOD_RETURN_TYPE Menu_AddItem(an::NAN_METHOD_ARGS_TYPE info);
Nan::NAN_METHOD_RETURN_TYPE Menu_DoModal(an::NAN_METHOD_ARGS_TYPE info);